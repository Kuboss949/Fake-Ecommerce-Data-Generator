...
"""
Ten plik przechowuje zapytania SQL do wykorzystania w generatorze danych (wersja MariaDB/MySQL).
...
DML_QUERIES = {
    ...
    # W MariaDB składnia UPDATE z JOIN działa bezpośrednio (i tak jest najwygodniej)
    "reset_amount_for_apolonia": """
                                 UPDATE CUSTOMER_ORDER AS CO
                                     INNER JOIN CUSTOMER AS C
                                 ON CO.CUSTOMER_ID = C.CUSTOMER_ID
                                     SET CO.TOTAL_AMOUNT = 0
                                 WHERE C.NAME = 'Apolonia Banak'
                                 """,
